...
export default function Analytics() {
  ...
  useEffect(() => {
    const loadAnalytics = async () => {
      try {
        const roomsRes = await axios.get("http://localhost:5000/api/admin/analytics/rooms-usage");
        const hoursRes = await axios.get("http://localhost:5000/api/admin/analytics/busy-hours");
